...
LOOT_TABLES = {
    "junk": [
        ...
        "Cooking Pot", "Desk Fan", "Fire Extinguisher", "Frying Pan",
...
CHEM_EFFECTS = {
    ...
    "Nuka-Cola": {"heal": 2, "ap": 1, "rads": 5, "hunger": -10, "desc": "Restores 2 HP, +1 AP, +5 rads, -10 hunger"},
    "Nuka-Cola Quantum": {"heal": 10, "ap": 5, "rads": 10, "hunger": -15, "desc": "Restores 10 HP, +5 AP, +10 rads, -15 hunger"},
    "Purified Water": {"heal": 5, "hunger": -5, "desc": "Restores 5 HP, -5 hunger"},
    "Dirty Water": {"heal": 2, "rads": 15, "hunger": -5, "desc": "Restores 2 HP, +15 rads, -5 hunger"},
    "Psycho": {"effect": "Rage", "duration": 3, "stat_mods": {"END": 1}, "damage_bonus": 3, "desc": "DMG +3, END +1 for 3 rounds. Addiction risk"},
    "Jet": {"effect": "Jet Rush", "duration": 2, "stat_mods": {"AGI": 2}, "desc": "AGI +2 for 2 rounds. Addiction risk"},
    "Mentats": {"effect": "Enhanced Cognition", "duration": 3, "stat_mods": {"INT": 2, "PER": 2}, "desc": "INT +2, PER +2 for 3 rounds. Addiction risk"},
    "Med-X": {"effect": "Pain Suppression", "duration": 3, "damage_reduction": 2, "desc": "Damage taken -2 for 3 rounds. Addiction risk"},
    "Buffout": {"effect": "Hulking", "duration": 3, "stat_mods": {"STR": 3, "END": 3}, "desc": "STR +3, END +3 for 3 rounds. Addiction risk"},
    "Mutant Jerky": {"heal": 3, "rads": 5, "hunger": -25, "desc": "Restores 3 HP, +5 rads, -25 hunger"},
    "Squirrel on a Stick": {"heal": 2, "hunger": -20, "desc": "Restores 2 HP, -20 hunger"},
    "Cram": {"heal": 5, "hunger": -30, "desc": "Restores 5 HP, -30 hunger"},
    "BlamCo Mac & Cheese": {"heal": 5, "hunger": -30, "desc": "Restores 5 HP, -30 hunger"},
    "Instant Mashed Potatoes": {"heal": 3, "hunger": -25, "desc": "Restores 3 HP, -25 hunger"},
    "Salisbury Steak": {"heal": 5, "hunger": -30, "desc": "Restores 5 HP, -30 hunger"},
    "Sugar Bombs": {"heal": 3, "rads": 5, "hunger": -20, "desc": "Restores 3 HP, +5 rads, -20 hunger"},
    "Fancy Lads Snack Cakes": {"heal": 3, "hunger": -20, "desc": "Restores 3 HP, -20 hunger"},
    "Dandy Boy Apples": {"heal": 3, "hunger": -20, "desc": "Restores 3 HP, -20 hunger"},
    "Mutfruit": {"heal": 3, "hunger": -20, "desc": "Restores 3 HP, -20 hunger"},
    "Beer": {"heal": 1, "hunger": -10, "desc": "Restores 1 HP, -10 hunger"},
    "Bourbon": {"heal": 1, "hunger": -10, "desc": "Restores 1 HP, -10 hunger"},
    "Military Rations": {"heal": 8, "hunger": -40, "desc": "Restores 8 HP, -40 hunger"},
}
