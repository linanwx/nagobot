...
CHEM_EFFECTS = {
    ...
    "Psycho": {"effect": "Rage", "duration": 3, "desc": "DMG +3, END +1 for 3 rounds. Addiction risk"},
    "Jet": {"effect": "Jet Rush", "duration": 2, "desc": "AGI +2, extra action for 2 rounds. Addiction risk"},
    "Mentats": {"effect": "Enhanced Cognition", "duration": 3, "desc": "INT +2, PER +2 for 3 rounds. Addiction risk"},
    "Med-X": {"effect": "Pain Suppression", "duration": 3, "desc": "Damage taken -2 for 3 rounds. Addiction risk"},
    "Buffout": {"effect": "Hulking", "duration": 3, "desc": "STR +3, END +3 for 3 rounds. Addiction risk"},
