...
Supported providers: `openai`, `openrouter`, `anthropic`, `deepseek`, `gemini`, `moonshot-cn`, `moonshot-global`, `zhipu-cn`, `zhipu-global`, `minimax-cn`, `minimax-global`, `siliconflow-cn`, `siliconflow-global`, `mimo`.
