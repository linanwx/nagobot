...
func init() {
	RegisterProvider("openrouter", ProviderRegistration{
		Models:       []string{"moonshotai/kimi-k2.6", "anthropic/claude-sonnet-4.6", "anthropic/claude-opus-4.6", "anthropic/claude-haiku-4.5", "z-ai/glm-5.2", "minimax/minimax-m3", "google/gemini-3.7-flash", "google/gemini-3.5-flash", "google/gemini-3.1-flash-lite", "openai/gpt-5.4-mini", "xiaomi/mimo-v2.5-pro", "xiaomi/mimo-v2.5"},
		VisionModels: []string{"moonshotai/kimi-k2.6", "anthropic/claude-sonnet-4.6", "anthropic/claude-opus-4.6", "anthropic/claude-haiku-4.5", "minimax/minimax-m3", "google/gemini-3.7-flash", "google/gemini-3.5-flash", "google/gemini-3.1-flash-lite", "openai/gpt-5.4-mini", "xiaomi/mimo-v2.5"},
		AudioModels:  []string{"google/gemini-3.7-flash", "google/gemini-3.5-flash", "google/gemini-3.1-flash-lite", "xiaomi/mimo-v2.5"},
