...
func init() {
	RegisterProvider("gemini", ProviderRegistration{
		Models:       []string{"gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"},
		VisionModels: []string{"gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"},
		AudioModels:  []string{"gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"},
